...
var types = []PrimitiveType{
	...
	{"Sfixed32", int32(0), protowire.Fixed32Type, "Fixed32", "uint32(%s)", "int32(%s)"},
	{"Sfixed64", int64(0), protowire.Fixed64Type, "Fixed64", "uint64(%s)", "int64(%s)"},
