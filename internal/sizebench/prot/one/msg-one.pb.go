...
const file_msg_one_proto_rawDesc = "" +
	"\n" +
	"\rmsg-one.proto\x12\x03one\"\x05\n" +
	"\x03Nop\"\x8a\b\n" +
	"\x05Types\x12\x14\n" +
	...
	"\amessage\x18\x10 \x01(\v2\f.one.MessageR\amessage\x12)\n" +
	"\blanguage\x18\x11 \x01(\x0e2\r.one.LanguageR\blanguage\x12\x16\n" +
	...
	"\bmessages\x18! \x03(\v2\f.one.MessageR\bmessages\x12+\n" +
	"\tlanguages\x18\" \x03(\x0e2\r.one.LanguageR\tlanguages\x12.\n" +
	"\x06values\x18# \x03(\v2\x16.one.Types.ValuesEntryR\x06values\x1a9\n" +
...
var (
	...
	file_msg_one_proto_rawDescData []byte
)

func file_msg_one_proto_rawDescGZIP() []byte {
	file_msg_one_proto_rawDescOnce.Do(func() {
		file_msg_one_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_msg_one_proto_rawDesc), len(file_msg_one_proto_rawDesc)))
	})
...
var file_msg_one_proto_goTypes = []any{
...
func file_msg_one_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_msg_one_proto_rawDesc), len(file_msg_one_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
