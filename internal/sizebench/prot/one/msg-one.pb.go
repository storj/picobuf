...
func file_msg_one_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_msg_one_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Nop); i {
			case 0:
				return &v.state
			case 1:
		...
		file_msg_one_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Types); i {
			case 0:
				return &v.state
			case 1:
		...
		file_msg_one_proto_msgTypes[2].Exporter = func(v any, i int) any {
