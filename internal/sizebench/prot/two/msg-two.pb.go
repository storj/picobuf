...
func file_msg_two_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_msg_two_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Nop); i {
			case 0:
				return &v.state
			case 1:
		...
		file_msg_two_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Types); i {
			case 0:
				return &v.state
			case 1:
		...
		file_msg_two_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_msg_two_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Types2); i {
			case 0:
				return &v.state
			case 1:
		...
		file_msg_two_proto_msgTypes[4].Exporter = func(v any, i int) any {
